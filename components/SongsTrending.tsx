              ...
              <div className='flex flex-col'>
                <div className='flex flex-row '>
                  <div className='relative mr-4 w-[70px] h-[70px] sm:w-[90px] sm:h-[90[x]] md:h-[140px] md:w-[140px]'>
                    <Image src="https://cdn1.suno.ai/c71ec50e-328b-4227-a2de-fab0bfb5cbc2_ee068b57.png" alt="song image" fill sizes='(max-width: 768px) 100vw, (max-width:1200px) 50vw, 33vw' className='absolute inset-0 w-full h-full rounded-md  border-2 border-orange-1' />

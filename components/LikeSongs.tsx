...
import { likeSongsData } from '@/constants'
  ...
  return (
    <section className='flex w-full flex-col gap-5 mb-10'>
      <div className='flex flex-row justify-between'>
        ...
        <h2 className='text-white-1 text-[20px] font-bold'>Like Songs</h2>
              ...
              <div className='flex flex-col'>
                <div className='flex flex-row '>
                  <div className='relative mr-4 h-[70px] w-[70px]'>
                    <Image src={song.image_url} alt={song.title} fill className='absolute inset-0 rounded-md  border-2 border-orange-1'

              ...
              <div className='flex flex-col'>
                <div className='flex flex-row '>
                  <div className='relative mr-4 h-[70px] w-[70px]'>
                    <Image src="https://cdn1.suno.ai/c71ec50e-328b-4227-a2de-fab0bfb5cbc2_ee068b57.png" alt="song image" fill className='absolute inset-0 rounded-md  border-2 border-orange-1'

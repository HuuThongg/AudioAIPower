...
const SongPlayer = () => {
  return (
    ...
    <div className='flex items-center z-50 border-t border-t-[#222222] bg-bg text-white-1'>
      <div className='flex flex-col items-stretch gap-2 pt-4 px-4 w-full h-full'>
        <div className='flex flex-row flex-1 items-center w-full gap-2'>
          <Image src="https://cdn1.suno.ai/image_a8d06999-b205-4a9f-9ad3-da5054e25bee.png" alt="song image" className='p-2 pr-1  aspect-square' width={56} height={56} />
          <div className='flex flex-col gap-1 flex-1'>
            <Link href="/song/1" className='outline outline-2 outline-transparent  text-xs font-bold'>Hudsa ds</Link>
            <p className='text-sm-text text-xs'>Author name</p>
          </div>
          <div className='flex items-center flex-shrink basis-0 grow-0'>
        ...
        tat ullamco ut ea consectetur et est culpa et culpa duis.
      </div>
    </div>
